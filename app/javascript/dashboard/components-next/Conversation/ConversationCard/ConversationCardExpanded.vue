  ...
  >
    ...
    <div class="flex items-center gap-2 min-w-0 flex-1">
      ...
      >
        <span
          v-if="isStarred"
          class="size-4 hover:text-[#ffb900] cursor-pointer i-ri-star-fill text-[#ffb900] opacity-100"
        />
        <span
          v-else
          class="size-4 hover:text-[#ffb900] cursor-pointer i-lucide-star text-muted-foreground opacity-30 group-hover:opacity-100 transition-opacity"
        />
      </button>
